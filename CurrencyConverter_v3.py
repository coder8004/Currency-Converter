...
class Main(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        # Create title label
        self.title_label = Label(self, text='Currency Converter', bg='grey', fg='white', font=(font, 20, "bold"), width=33, height=3, relief='ridge')

        # Create date label
        self.date_label = Label(self, text="Rates as of:\n" + f'{dt.datetime.now():%A, %B %d, %Y}', bg='green', fg='white', font=(font, 12))
        ...
        self.final_result = Label(self, text='', bg='black', fg='white', font=(font, 15, "bold"), relief='sunken', width=35, height=2)
